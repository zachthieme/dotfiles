...
require("lazy").setup({
  {
    ...
    opts = {
      ...
      disable_frontmatter = false, --{ enabled = true },
    ...
    config = function(_, opts)
      ...
      vim.keymap.set("n", "<leader>q", "<cmd>CToggle<CR>", { desc = "Toggle quickfix list" })
      ...
      wk.add({
        ...
        { "<leader>nt", "<cmd>ObsidianTags<CR>", desc = "Tags", mode = "n" },
...
vim.api.nvim_create_autocmd("FileType", {
  pattern = "markdown",
  callback = function()
    -- Map Markdown heading levels to Neorg headings
    vim.cmd("highlight! link @markup.heading.1.markdown @neorg.headings.1.title.norg")
    vim.cmd("highlight! link @markup.heading.2.markdown @neorg.headings.2.title.norg")
    vim.cmd("highlight! link @markup.heading.3.markdown @neorg.headings.3.title.norg")

    -- Map Markdown links, bold, and italic
    vim.cmd("highlight! link @markup.link.markdown @neorg.links.file.norg")
    vim.cmd("highlight! link @markup.strong.markdown @neorg.markup.bold.norg")
    vim.cmd("highlight! link @markup.emphasis.markdown @neorg.markup.italic.norg")
  end,
})
