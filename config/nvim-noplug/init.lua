...
-- Move lines up/down - removed as they don't work with my keybindings
...
-- TODO: changes these to use mini.files and fzf or other finder
...
-- Quick config editing - removed as i have this in a non-standard location
