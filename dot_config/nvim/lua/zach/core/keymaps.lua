...
keymap.set("n", "<leader>zz", "<cmd> Pencil | TZMinimalist<CR>", { desc = "testing stuff" })
keymap.set(
  "n",
  "<leader>wn",
  "<cmd>:topleft vs <BAR>vertical resize 50 <BAR>norm Gzt<cr> <BAR><cmd>Pencil <BAR>TZMinimalist<cr>",
